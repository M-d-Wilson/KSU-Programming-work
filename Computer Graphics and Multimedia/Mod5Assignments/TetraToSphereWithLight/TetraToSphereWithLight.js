...
window.onload = function init() {
    ...
    document.addEventListener("keydown",
        function (event) {
            ...
            if (event.keyCode == 65 || event.keyCode == 37) {   // Left Arrow and A
                theta += 0.1;
            }
            if (event.keyCode == 68 || event.keyCode == 39) {   // Right Arrow and D
                theta -= 0.1;
            }
            if (event.keyCode == 87 || event.keyCode == 38) {   // Up Arrow and W
                phi += 0.1;
            }
            if (event.keyCode == 83 || event.keyCode == 40) {   // Down Arrow and S
                phi -= 0.1;
            }
        }, false);
