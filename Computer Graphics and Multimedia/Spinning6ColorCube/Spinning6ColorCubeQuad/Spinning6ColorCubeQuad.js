...
var vertexColors2 = true;
var cBuffer;

var vertexColors2 = [
    vec4(0.2, 0.5, 0.2, 1.0),  // cyan
    vec4(0.0, 0.1, 0.5, 1.0),  // black
    vec4(0.5, 0.4, 0.6, 1.0),  // red
    vec4(0.7, 0.0, 0.8, 1.0),  // yellow
    vec4(0.0, 0.6, 0.5, 1.0),  // green
    vec4(0.0, 0.8, 0.6, 1.0),  // white
    vec4(0.4, 0.9, 0.7, 1.0),  // blue
    vec4(0.5, 0.7, 0.9, 1.0)   // magenta
];
window.onload = function init() {
    ...
    document.getElementById("Change Colors").onclick =
        function () {
